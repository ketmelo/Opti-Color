      ...
      <div className='absolute text-white top-56 flex flex-wrap flex-col xl:flex-row justify-center gap-8 flex flex-wrap justify-center lg:mt-20'>
        ...
        <div className='w-44 h-80 bg-fundo-bg rounded-lg flex flex-col items-center relative mt-20 '>
          <div>
            ...
            <h2 className='text-base text-center mt-5 font-bold'>17 anos</h2>
        ...
        <div className='w-44 h-80 bg-fundo-bg rounded-lg flex flex-col items-center relative mt-20 xl:ml-10 xl:ml-20'>
          <div>
            <img src={ketlyn} alt="" className='-top-12 relative' />
            <h1 className='text-xl text-bold text-center font-bold'>Ketlyn Melo</h1>
            <h2 className='text-base text-center mt-5 font-bold'>17 anos</h2>
            <div className='flex mt-5 items-center justify-center'>
            <a href=""><img src={linkedin} alt="" className='h-7 '/></a>
        ...
        <div className='w-44 h-80 bg-fundo-bg rounded-lg flex flex-col items-center relative mt-20 xl:ml-20'>
          <div>
