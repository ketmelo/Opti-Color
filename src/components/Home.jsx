  ...
  <div className='min-h-screen flex flex-col justify-center items-center bg-fundo-bg'>
    <div
      ...
      >
         ...
         <Header></Header>
         <h1 className='relative text-white text-right font-aoboshi w-44 ml-24   lg:ml-[670px] mt-6 xl:text-4xl lg:mt-72 lg:mb-96 lg:ml-[300px] xl:ml-[1000px] lg:w-[460px] lg:h-44'>OPTI-COLOR: O FUTURO PERTENCE ÀQUELES QUE ABRAÇAM A MUDANÇA.</h1>
    </div>
       

    <div className="w-[300px] h-[400px] bg-bg-container mt-20 rounded-lg lg:w-full lg:h-full lg:max-w-[82vw] lg:h-[35vh]">
      <div className="flex flex-col lg:flex-row items-center justify-center h-full p-6">
        ...
        <h1 className="text-white text-right text-base lg:text-3xl lg:w-[950px]">
          ...
          <div className="w-[300px] h-[400px] bg-bg-container mt-20 rounded-lg lg:w-full lg:h-full lg:max-w-[82vw] lg:h-[35vh] ">
            <div className="flex flex-col lg:flex-row items-center justify-center h-full p-6">
              ...
              <h1 className='text-white  text-base text-left p-6 mt-12 lg:mt-0  lg:text-3xl lg:w-[950px]'>
              ...
              <img src={cerebro} alt="Lâmpada" className="w-36 lg:w-48 mb-6 lg:mb-0 lg:mr-6 mt-0 lg:ml-48 lg:h-96 lg:w-60" />
            </div>
          </div>

          <div className="w-[300px] h-[430px] lg:h-[400px] bg-bg-container mt-20 rounded-lg lg:w-full lg:h-full lg:max-w-[82vw] lg:h-[35vh] mb-20">
            <div className="flex flex-col lg:flex-row items-center justify-center h-full p-6">
              <img src={maos} alt="Lâmpada" className="w-36 lg:w-48 mb-6 lg:mb-0 lg:mr-6  lg:h-96 lg:w-72 lg:mr-48" />
              <h1 className='text-white text-center text-base text-right p-6 lg:text-3xl lg:w-[950px]  '>
