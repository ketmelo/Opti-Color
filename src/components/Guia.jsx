...
export default function Guia() {
  return (
    <div className='min-h-screen flex flex-col justify-center items-center bg-fundo-bg'>
      <div
        className="relative rounded-lg w-[300px] h-[800px] top-10 xl:w-[1600px] xl:h-[800px] bg-gradient-to-r from-azulEscuro/60 via-verdinho/100 to-azulzao/60 mb-24 lg:h-screen lg:w-screen ">
         <div className="absolute inset-0 bg-black lg:bg-opacity-80 bg-opacity-60 rounded-lg"></div>
         <Header></Header>
         <h1 className='relative text-white font-aoboshi w-44 ml-[120px] mt-6 lg:text-5xl lg:mt-10 lg:ml-16  xl:mt-32'>G U I A</h1>
         
         
         
         <div className='relative text-white lg:flex '>
      <div className='lg:flex lg:flex-col  lg:text-3xl space-y-4 text-sm p-16 text-n  '>
      ...
      <img src={sirene} alt="Sino" className="lg:ml-8 lg:h-72 lg:mr-10 h-32 ml-[120px] lg:mt-12 " />
