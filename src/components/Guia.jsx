...
export default function Guia() {
  return (
    <div className='min-h-screen flex flex-col justify-center items-center bg-fundo-bg'>
      <div
        className="relative rounded-lg w-[300px] h-[800px] top-10 md:w-[600px] md:h-[600px] lg:w-[1200px] lg:h-[800px] bg-verdinho/60 md:bg-gradient-to-r md:from-azulEscuro/60 md:via-verdinho/100 md:to-azulzao/60 mb-24 lg:h-screen lg:w-screen">
